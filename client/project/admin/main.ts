...
// const layoutData = new LayoutData(Conf.combinedHTML.url);
// layoutData;

// const useLayoutData = (layoutStore: KVStore<Element>) => {
...
//                                                     const createQuizXhr = ajaxPost("/api/admin/quiz", {
//                                                         questionId,
//                                                         availableStart,
//                                                         availableEnd,
//                                                         blackboardColumnId,
...
//                                                                     // Get quiz schedule to transit to
//                                                                     const quizSchedule = data.payload.filter(quizSchedule => quizSchedule._id === insertedId)[0];
