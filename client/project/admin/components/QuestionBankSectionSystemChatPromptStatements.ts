...
export class QuestionBankSectionSystemChatPromptStatements extends ComponentRenderable {
    ...
    private systemChatPromptStatements: string[] | null | undefined = null;
    ...
    public readonly getContent = () => {
        return this.systemChatPromptStatements;
    }
    ...
    private readonly addStatement = (text: string) => {
        ...
        this.systemChatPromptStatements.push(text);
    ...
    private readonly addNewStatement = () => {
    ...
    private readonly renderStatementList = () => {
        ...
        this.systemChatPromptStatements!.forEach((statement: string, i: number) => {

            $('<div/>', {
                "class": 'prompt-list-item',
            }).data("index", i).append(this.getTextContentBox(statement)).append(this.getControls()).appendTo($promptListEl);
        });
    }
    ...
    private readonly getControls = () => {
            ...
            "click": (e: JQueryEventObject) => {
                ...
                $textBox.on('keydown focusout', (e: JQueryEventObject) => {
                    if((e.type === "keydown" && e.keyCode === 13) || e.type === "focusout") {
                        ...
                        this.systemChatPromptStatements![currentIndex] = newContent;
        ...
        return $controls.append($up, $down, $delete, $edit);
    }
