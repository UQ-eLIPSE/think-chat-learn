...
export default class MoocChatPage extends Vue {
  ...
  private emitGroupUpdate(
    ...
    if (
      this.chatGroup.groupAnswers[this.currentResponse.questionId] &&
      this.chatGroup.groupAnswers[this.currentResponse.questionId].find(
        element => {
